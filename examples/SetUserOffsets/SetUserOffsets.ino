...
void setup() {
	...
	imu
	  .computeOffsets();  //note, Full scale used are dps2000 for gyro and gm2 for accelerometers. user full scale are restored after offsets
	imu.setAllOffsets();
	Serial.println("raw Bias:");
	Serial.print(imu.rawBiasAccX());
	Serial.print("\t");
	Serial.print(imu.rawBiasAccY());
	Serial.print("\t");
	Serial.print(imu.rawBiasAccZ());
	Serial.print("\t");
	Serial.print(imu.rawBiasGyrX());
	Serial.print("\t");
	Serial.print(imu.rawBiasGyrY());
	Serial.print("\t");
	Serial.print(imu.rawBiasGyrZ());
	Serial.print("\t");
	Serial.println("");
	delay(1000);
...
void loop() {
	...
	Serial.print("\t");
	Serial.print(GyrXraw);
	Serial.print("\t");
	Serial.print(GyrYraw);
	Serial.print("\t");
	Serial.print(GyrZraw);
	Serial.print("\t");
